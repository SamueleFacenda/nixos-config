# first line for filetype recognition in micro
{
  ...
  inputs = {
    ...
    nixpkgs.url = "https://channels.nixos.org/nixos-unstable/nixexprs.tar.zst"; # Faster and non GH dependant
    ...
    asus-dialpad-driver = {
      url = "github:toastal/asus-dialpad-driver/nix-user-hardware";
    ...
    ieri-oggi = {
      url = "github:SamueleFacenda/ieri_oggi";
      inputs.nixpkgs.follows = "nixpkgs";
      inputs.flake-utils.follows = "flake-utils";
    };
  };
